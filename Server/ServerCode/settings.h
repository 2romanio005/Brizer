...
#define portHTTP 80
#define portWebSocket 81


#define change_settings_password "2020"
#define change_memory_password "memory"

#define WIFI_ssid     "point"         // Для хранения SSID
#define WIFI_password "555energy555"  // Для хранения пароля сети



#ifndef type_brizer
//8C:AA:B5:1B:16:76
#define broadcastAddress (new uint8_t[6]{0x8C, 0xAA, 0xB5, 0x1B, 0x16, 0x76}) // MAC-адрес получателя
