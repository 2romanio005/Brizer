...
GyverWDT Watchdog;                           // ватчдог для перезагрузки при зависании
...
byte cmd[9] = {0xFF, 0x01, 0x86, 0x00, 0x00, 0x00, 0x00, 0x00, 0x79};  // для считывания CO2
byte response[9];                                                      // для считывания CO2
...
void setup() { // ===================================================== VOID SETUP() ================================================================================
  ...
  */
  ...
  /*
    ...
    день второго-все_отальные_месяца: namber_list_temp_and_hot + 124 + 4 * (кол_дней в всех_пред_мес(кроме 1) - 1)     + 4 * нжный день
  */
